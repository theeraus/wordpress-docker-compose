<?php
	/*-------------------------------
	    MAIN MENU
	--------------------------------*/
	if ( !function_exists('saasmax_menu')) {
		function saasmax_menu(){
			// Page Meta Data
	        ...
	        $menu_width = saasmax_any_data('menu_width','container');
	    ...
	    ?>
	    <div class="header-top-area header-alt-3">
	    	<?php
	    		$search_style = '';
	    		if ( $search_style ) {
			...
			<div class="search-form-control">
				<div id="search-form-<?php echo esc_attr( $search_style )?>" class="search-form-<?php echo esc_attr( $search_style )?>">					
	    			<?php saasmax_search_form(false,false); ?>
				</div>
	                        ...
	                        <div class="col-md-12 flex-v-center">
	                            ...
	                            <?php
	                                wp_nav_menu( array(
										...
										'fallback_cb'     => 'saasmax_menu_default_fallback',
										'walker'          => new saasmax_Nav_Menu_Walker(),
	                                ) );
	                            ?>
	...
	/*----------------------------
	    MENU FALBACK
	-----------------------------*/
	if (!function_exists('saasmax_menu_default_fallback')) {
	    function saasmax_menu_default_fallback() {
	        ?>
	        <div id="main-nav" class="stellarnav">            
	            <ul id="nav" class="nav navbar-nav pull-right">
	                <li>
	                    <a href="<?php echo admin_url(); ?>nav-menus.php">
	                        <?php esc_html_e( 'Set Mainmenu Here...', 'saasmax' ); ?>
	                    </a>
	                </li>
	            </ul>
	        </div>
